<template>
  <div class="main-content flex-1 bg-gray-100 mt-16 pb-24 md:pb-5">

    <div class="bg-gray-300 p-2 shadow-inner text-xl text-gray-800 border-t-4 border-gray-800 rounded-t-md mx-2 mt-1">
