<template>
    <div class="bg-gray-800 h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:max-w-xs">
        <div class="w-full md:max-w-xs md:mt-16 md:mx md:fixed md:left-0 md:top-0 content-center md:content-start pt-1">
            <ul class="flex flex-col w-full">
                <li class="my-px">
                    <a href="#"
                       class="flex flex-row items-center h-12 mx-1 px-4 rounded-t-md text-gray-600 bg-gray-200">
                ...
                <li class="my-px">
                    ...
                    <hr class="flex border-0 bg-gray-700 text-gray-700 h-px">
                </li>
                <li class="my-px">
                    <a href="#"
